...
local _MINIMAL_EDUCATION_INVESTMENT_ = 15
local _AVERAGE_EDUCATION_INVESTMENT_ = 16
local _MEDIUM_LARGE_EDUCATION_INVESTMENT_ = 17
local _BIG_EDUCATION_INVESTMENT_ = 18
--
local _CONSUMER_PRODUCT_ORIENTATION_ = 19
local _MIXED_INDUSTRY_ = 20
local _HEAVY_INDUSTRY_EMPHASIS_ = 21

local _FREE_PRESS_ = 22
local _CENSORED_PRESS_ = 23
local _STATE_PRESS_ = 24
local _PROPAGANDA_PRESS_ = 25
